...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # It's an alias for reduce: it applies an operation specified by a block
    #   to an array of values, with an optional starting value.
  end
  ...
  #
  # This was done to close the file descriptor at the completion of the block
