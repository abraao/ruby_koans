...
class AboutMethods < Neo::Koan
  ...
  # runtime error.
  #
  # :˜( I sure hope there are static analysis tools that throw errors for this
  ...
  def method_with_explicit_return
    :a_non_return_value
    return :return_value
    :another_non_return_value # Why isn't this a syntax error?
  end
  ...
  # I'm running Ruby MRI 3.0.3p157
